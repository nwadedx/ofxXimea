...
#define	MV40_DLL_VERSION_LOW 3
#define	MV40_DLL_VERSION_COMPILE 3
...
#define	MQ_SYS_VERSION_HIGH			1
#define	MQ_SYS_VERSION_LOW			0
#define	MQ_SYS_VERSION_COMPILE		11
...
#define	API_INST_PACKAGE_VERSION_LOW 03
#define	API_INST_PACKAGE_COMPILE 03
